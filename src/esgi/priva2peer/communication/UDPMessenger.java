...
public class UDPMessenger
{
	 ...
	 * @param tag a valid string, used to filter the UDP broadcast messages (in
	 *            and out). It can't be null or 0-characters long.
	 * @param multicastPort the port to multicast to. Must be between 1025 and
	 *            49151 (inclusive)
	 * @param connectionPort the port to get the connection back. Must be
	...
	/**
	 * Sends a broadcast message (TAG EPOCH_TIME message). Opens a new socket in
	 * case it's closed.
	 * 
	 * @param message the message to send (multicast). It can't be null or
	 *            0-characters long.
	 * @return
	...
	public String ipToString(int ip, boolean broadcast)
	{
