...
public class Client implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			...
			while (true)
			{
				List<esgi.priva2peer.communication.message.Message> listM = MessageQueue.getAllMessages(cli.getStrName());
				if (listM != null && !listM.isEmpty())
				{
					for (esgi.priva2peer.communication.message.Message message : listM)
					{
